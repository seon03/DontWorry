...
function BudgetScheduleCircle({ setCategoryPositions }) {
    const [categories, setCategories] = useState([
        { id: 1, name: '약속', color: '#5E64FF', budget: 180 },
        { id: 2, name: '시험', color: '#A045E7', budget: 30 },
        { id: 3, name: '휴가', color: '#8F64A9', budget: 110 },
        { id: 4, name: '문화생활', color: '#5B47D6', budget: 50 },
        { id: 5, name: '출장', color: '#A86EAD', budget: 50},
        //{ id: 6, name: '생일', color: '#BCBEFF' },
        //{ id: 7, name: '여행', color: '#BCBEFF' },
        //{ id: 8, name: '휴가', color: '#BCBEFF' },
        //{ id: 9, name: '가족', color: '#BCBEFF' , budget:20},
        //{ id: 10, name: '이벤트', color: '#BCBEFF' },
        //{ id: 11, name: '운동', color: '#BCBEFF' , budget: 10},
        //{ id: 12, name: '결혼식', color: '#BCBEFF' },
        //{ id: 13, name: '병원', color: '#BCBEFF' },
        //{ id: 14, name: '강의', color: '#BCBEFF' },
        //{ id: 15, name: '기타', color: '#BCBEFF' }
    ]);
    ...
    const drawChart = () => {
        ...
        nodeGroup.each(function (d) {
            ...
            const pieData = pie([
                { value: d.data.budget * 0.6, type: 'actual' },
    ...
    return (
        <div className="fluid-account-bubble-lq-c">
            <div className="_6-lq-c" style={{ top: '90px' }}>{currentMonth} 일정</div>
...
export default BudgetScheduleCircle;
