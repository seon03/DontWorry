...
function BudgetLiquidCircle2({ setCategoryPositions }) {
    const [categories, setCategories] = useState([
        { id: 1, name: '식비', color: '#57B2BE', budget: 80 },
        { id: 2, name: '문화생활', color: '#ff8585', budget: 120 },
        { id: 4, name: '주거', color: '#2532FF', budget: 40 },
        { id: 5, name: '교육', color: '#39AFD4', budget: 120 },
...
export default BudgetLiquidCircle2;
